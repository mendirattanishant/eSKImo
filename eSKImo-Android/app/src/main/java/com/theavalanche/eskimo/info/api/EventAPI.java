...
public interface EventAPI {
    @FormUrlEncoded
    @POST("/createEvent")
    EventInfo createEvent(@Field("event_id") int event_id, @Field("user_id") int user_id, @Field("event_details") String  event_details,
    ...
    List<EventInfo> getAttendingEvents  (@Field("event_id") int event_id, @Field("user_id") int user_id);
